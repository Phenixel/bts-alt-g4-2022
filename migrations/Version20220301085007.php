 ...
 */
final class Version20220301085007 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE interaction (id INT AUTO_INCREMENT NOT NULL, med_perturbateur INT NOT NULL, med_med_perturbe INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('DROP TABLE interraction');
        $this->addSql('ALTER TABLE dosage CHANGE dos_quantite dos_quantite VARCHAR(10) DEFAULT NULL COLLATE `utf8_unicode_ci`, CHANGE dos_unite dos_unite VARCHAR(10) DEFAULT NULL COLLATE `utf8_unicode_ci`');
