 ...
 */
final class Version20220319230916 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE dosage CHANGE dos_quantite dos_quantite VARCHAR(255) DEFAULT NULL, CHANGE dos_unite dos_unite VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE prescrire CHANGE med_depotlegal med_depotlegal INT NOT NULL');
    }
