import { DeepPartial, DistributiveArray, UnionToIntersection } from 'chart.js/types/utils';
...
import { ChartArea, Point } from 'chart.js/types/geometric';
import { LayoutItem, LayoutPosition } from 'chart.js/types/layout';

export { DateAdapter, TimeUnit, _adapters } from 'chart.js/types/adapters';
export { Animation, Animations, Animator, AnimationEvent } from 'chart.js/types/animation';
export { Color } from 'chart.js/types/color';
export { Element } from 'chart.js/types/element';
export { ChartArea, Point } from 'chart.js/types/geometric';
export { LayoutItem, LayoutPosition } from 'chart.js/types/layout';
